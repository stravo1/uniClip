    ...
    <div class="modal-background"></div>
      <div class="modal-content">
            ...
            <div class="card-header">
                <div class="card-header-icon">
                    <figure class="image is-48x48 is-centered">
                        <img src="../assets/error.png" alt="Placeholder image">
                    </figure>
                </div>
        ...
        <footer class="card-footer">
            <button class="button is-primary card-footer-item" @click="sIN">Sign In</button>
        </footer>
    </div>
  </div>
  </div>
...
export default {
    ...
    methods:{
        async signInStateUpdate(arg){
            ...
            this.$store.commit('setAccessToken',gapi.auth2.getAuthInstance().currentUser.get().getAuthResponse().access_token)
            ...
            if (!id){
                ...
                await this.$store.dispatch('setUpDevices')
